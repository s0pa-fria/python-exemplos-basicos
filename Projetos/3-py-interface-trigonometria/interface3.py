...
def resource_path(relative_path):
    """
    Obtém o caminho absoluto para o recurso, funciona tanto em ambiente de desenvolvimento quanto após o emcapotamento com Pyinstaller.
    """
    try:
        # Pyinstaller cria um diretório temporário e armazena o caminho em_MEIPASS
        base_path = sys._MEIPASS
    except Exception:
        # Se não tiver executando pelo Pyinstaller, utiliza o caminho absoluto do diretório atual
...
def calcular():
    """
    Realiza o cálculo dos valores trigonométricos (seno, cosseno e tangente) do ângulo fornecido e atualiza as labels com os resultados.
    """
    try:
...
def validar_entrada(texto):
    """
    Valida a entrada do usuário permitido apenas números e garantindo que o valor esteja entre 0 e 90.
    """
...
botao_limpar = tk.Button(frame_botoes, text="Limpar", command=calcular, font=('Arial', 12), bg="#d9d9d9", relief='flat', bd=0, highlightthickness=0)
